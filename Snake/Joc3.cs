...
namespace Snake
{
    public partial class Joc3 : Form
    {
        ...
        private void Joc3_Paint(object sender, PaintEventArgs e)
        {
            e.Graphics.FillRectangle(Brushes.DarkSeaGreen, 20, 60, 640, 380);

            e.Graphics.FillRectangle(Brushes.Black, 100, 140, 20, 220);
            e.Graphics.FillRectangle(Brushes.Black, 120, 140, 180, 20);
            e.Graphics.FillRectangle(Brushes.Black, 120, 340, 180, 20);

            e.Graphics.FillRectangle(Brushes.Black, 560, 140, 20, 220);
            e.Graphics.FillRectangle(Brushes.Black, 400, 140, 180, 20);
            e.Graphics.FillRectangle(Brushes.Black, 400, 340, 180, 20);
        ...
        private int verif_food()
        {
            ...
            if (yf == 140 || yf == 340)
            {
                for (i = 120; i <= 280; i = i + 20)
                    if (xf == i)
                        return 0;
                for (i = 400; i <= 540; i = i + 20)
                    if (xf == i)
                        return 0;
            }
        ...
        private void Joc3_KeyDown(object sender, KeyEventArgs e)
        {
